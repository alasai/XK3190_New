...
namespace YIEternalMIS.Common
{
    ...
    public static class StringISNULL
    {
        /// <summary>
        /// 判断字符串是否为空
        /// </summary>
        ...
        /// <summary>
        /// 字符串是否为空，为空返回rtn 不为空返回本身
        /// </summary>
        /// <param name="s"></param>
        /// <param name="rtn"></param>
        /// <returns></returns>
        public static string Isnull( string s , string rtn )
        {
            if (s == null && s == String.Empty) return rtn;
            return s;
        }
    }
}
